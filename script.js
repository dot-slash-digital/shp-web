...
const faqQuestions = [
    ...
    {
        question: "How long should I expect to wait after reaching out to hear back?",
        answer: [
...
function faqQuestionAndNavbarBehavior() {
    ...
    const openHeight = $(".content.navbar").outerHeight() + $(".content.navbar .right-column").outerHeight() + 32;
